package com.herval.store.web.rest;

import com.herval.store.StoreApp;

import com.herval.store.domain.OrderItem;
import com.herval.store.repository.OrderItemRepository;
import com.herval.store.service.OrderItemService;
import com.herval.store.web.rest.errors.ExceptionTranslator;
...
import static com.herval.store.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.herval.store.domain.enumeration.OrderItemStatus;
/**
...
public class OrderItemResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_TOTAL_PLACE = new BigDecimal(0);
    private static final BigDecimal UPDATED_TOTAL_PLACE = new BigDecimal(1);
    ...
    public static OrderItem createEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem()
            ...
            .totalPlace(DEFAULT_TOTAL_PLACE)
    ...
    public void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getTotalPlace()).isEqualTo(DEFAULT_TOTAL_PLACE);
    ...
    @Test
    @Transactional
    public void checkTotalPlaceIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderItemRepository.findAll().size();
        // set the field null
        orderItem.setTotalPlace(null);
    ...
    public void getAllOrderItems() throws Exception {
        ...
        restOrderItemMockMvc.perform(get("/api/order-items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].totalPlace").value(hasItem(DEFAULT_TOTAL_PLACE.intValue())))
    ...
    public void getOrderItem() throws Exception {
        ...
        restOrderItemMockMvc.perform(get("/api/order-items/{id}", orderItem.getId()))
            ...
            .andExpect(jsonPath("$.totalPlace").value(DEFAULT_TOTAL_PLACE.intValue()))
    ...
    public void updateOrderItem() throws Exception {
        ...
        updatedOrderItem
            ...
            .totalPlace(UPDATED_TOTAL_PLACE)
        ...
        assertThat(testOrderItem.getTotalPlace()).isEqualTo(UPDATED_TOTAL_PLACE);
