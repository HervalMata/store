package com.herval.store.repository;

import com.herval.store.StoreApp;
import com.herval.store.config.Constants;
import com.herval.store.config.audit.AuditEventConverter;
import com.herval.store.domain.PersistentAuditEvent;
...
import static com.herval.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
