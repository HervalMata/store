...
describe('ProductOrder e2e test', () => {
    ...
    it('should create and save ProductOrders', async () => {
        await productOrderComponentsPage.clickOnCreateButton();
        await productOrderUpdatePage.setPlaceDateInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
        expect(await productOrderUpdatePage.getPlaceDateInput()).toContain('2001-01-01T02:30');
